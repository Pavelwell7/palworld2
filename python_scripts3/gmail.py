...
На курсы, которые еще не вышли, можно подписаться и получить о релизе сразу на имейл.""".replace("%website%", "https://dvmn.org/profession-ref-program/pavelbugaev303/DBszV/"))