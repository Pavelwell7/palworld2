...
На курсы, которые еще не вышли, можно подписаться и получить о релизе сразу на имейл.""".format(infitation=infitation,email_from=email_from,email_to=email_to)
